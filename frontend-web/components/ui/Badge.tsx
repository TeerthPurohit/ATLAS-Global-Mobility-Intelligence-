...
// ADR-007: computed = confident solid brass fill, modeled_estimate = dashed
// verdigris "estimated" treatment, unavailable = muted oxide/dashed. Also
// usable as a plain badge (no basis) with default styling.
  ...
  return (
    <span
      className={cn(
        ...
        basis ? basisClasses[basis] : "bg-surface-2 text-ink-secondary",
        className
      )}
      {...props}
    />
