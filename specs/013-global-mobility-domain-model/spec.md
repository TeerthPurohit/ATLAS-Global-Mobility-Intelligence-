...
> then further by [ADR-012](../../docs/adr/ADR-012-nyc-only.md).**
> The global-coverage layer this describes has been removed. London (added
> after this spec was written) was also removed by ADR-012 -- the platform
> now serves NYC only. Kept as a record of the decision and why it was
> reversed, not as a description of the current system.

Owner: solo builder · Status: superseded · Layer: 5+ (extends Layers 1, 4, 5) ·
